/**
 * @description Authentication Middleware for Organization
 * Validates JWT tokens from Authorization header
 */

const jwt = require('jsonwebtoken');

exports.validateOrgToken = (req, res, next) => {
    try {
        ...
        const decoded = jwt.verify(token, process.env.JWT_SECRET_STRING || 'your-secret-key');
...
exports.optionalOrgAuth = (req, res, next) => {
    try {
        const authHeader = req.headers.authorization;
