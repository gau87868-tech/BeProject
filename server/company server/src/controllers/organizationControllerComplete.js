...
exports.getDashboardStats = asyncHandler(async (req, res) => {
    ...
    const interviews = await Interview.countDocuments({ organizationId: id, isActive: true });
    ...
    res.status(200).json({
        ...
        data: {
            ...
            completedInterviews,
            averageScore: (averageScore[0]?.avgScore || 0).toFixed(2)
        }
    });
});
...
exports.registerCompany = exports.registerOrganization;
exports.login = exports.loginOrganization;
